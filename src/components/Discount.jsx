    ...
    <div className="section overflow-hidden">
      <div className="wrapper relative overflow-hidden">
        <div className="bg-brown-100 flex flex-col lg:flex-row gap-y-10 md:gap-y-12 lg:gap-y-0 lg:gap-x-20 xl:gap-x-28 pt-10 pr-10 pb-0 pl-10 lg:pt-16 lg:pr-16 lg:pl-16 xl:pt-20 xl:pr-20 xl:pl-20 2xl:pt-36 2xl:pr-36 2xl:pl-36">
          {/* text */}
          <div
            className="lg:flex-[55%] w-[70%] md:w-[50%] mx-auto flex flex-col items-center lg:items-start justify-center text-center lg:text-left gap-y-4 lg:gap-y-6 lg:mb-8 xl:mb-20 2xl:mb-36 z-[20]"
            data-aos="fade-up"
            data-aos-delay="400"
          >
          ...
          {/* image */}
          <div
            className="lg:flex-[45%] h-[40vh] md:h-[50vh] lg:h-[40vh] xl:h-[60vh] 2xl:h-[55vh] w-[90%] md:w-[70%] mx-auto flex justify-center items-center z-[20]"
            data-aos="fade-up"
            data-aos-delay="600"
          >
